...
data_path = "/home/kevmepls/Documents/IR/APIforDDICorpus/DDICorpus/Test/Test for DDI Extraction task/DrugBank/ML/"

data = pd.read_csv(data_path+"trainFeatures1.csv", header=0, delimiter=",")
