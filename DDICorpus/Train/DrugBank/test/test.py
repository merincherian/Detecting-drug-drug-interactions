...
text = "Aminosalicylic acid may also decrease the absorption of vitamin B12, which can lead to a deficiency and thus not recommended simultaneously."
...
class_l = 1
data = [feature1,feature2,feature3,feature4,feature5,feature6,feature7,feature8,feature9]
...
if y_pred==1:
	print ("The sentence describes about a drug-drug interaction")
else:
	print ("The sentence does not describe about a drug-drug interaction")
